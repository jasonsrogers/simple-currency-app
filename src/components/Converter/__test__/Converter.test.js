...
describe("Converter: component renders correctly", () => {
  ...
  it("Displays No pocket selected yet", () => {
    ...
    expect(converterWrapper.find(".converter_exchange").exists()).toBeFalsy();
  });
  it("Displays conversion form/to", async () => {
    ...
    expect(converterWrapper.find(".converter_exchange").exists()).toBeTruthy();
  });
  it("Displays conversion from (awaiting the selection of a to)", async () => {
    ...
    expect(text).toContain("To Value USD");
    expect(text).toContain("Current rate: 1.5");
    expect(converterWrapper.find(".converter_switch-currency")).toHaveLength(1);
  });
  it("Displays conversion form", async () => {
    ...
    expect(converterWrapper.find(".converter_switch-currency")).toHaveLength(2);
  });
});
...
describe("Converter: component inputs/buttons", () => {
  it("Should trigger select pocket callback", () => {
    ...
    const button = converterWrapper.find(".converter_switch-currency");
  ...
  it("Should trigger select exchange callback", () => {
    ...
    const button = converterWrapper.find(".converter_exchange");
    expect(button).toHaveLength(1);
  ...
  it("Should trigger exchange with field values", () => {
    ...
    const submitButton = converterWrapper.find(".converter_exchange");
    const fromValue = converterWrapper.find(".converter_from-value");
    const toValue = converterWrapper.find(".converter_to-value");
